<template>
    <div class="mt-8 border-l-4 border-rose-400 bg-rose-100 p-4">
        <div class="px-4 py-5 sm:p-6">
            ...
            <div class="mt-2 max-w-xl text-sm text-gray-500">
                <p>
                    Pour effectuer un retrait, nous vous invitons à créer au
                    préalable un compte de retrait Orange ou MTN.
                </p>
            </div>
            <div class="mt-5">
                <Link
                    ...
                    >Créez votre compte de retrait</Link
                >
            </div>
        </div>
    </div>

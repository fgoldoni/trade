            ...
            <li v-for="person in referrals" :key="person.id" class="col-span-1 divide-y divide-gray-100 rounded-lg bg-slate-300 shadow">
                <div class="flex w-full items-center justify-between space-x-6 p-6">
                    <div class="flex-1 truncate">
                        <div v-if="person.products.length" class="flex items-center space-x-3 mb-2" v-for="product in person.products" :key="product.id">
                        ...
                        <p class="text-rose-500 font-bold" v-else>

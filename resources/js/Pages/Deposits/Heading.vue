    ...
    <div>
        ...
        <div class="mt-2 md:flex md:items-center md:justify-between">
            <div class="min-w-0 flex-1">
                <h2 class="text-2xl/7 font-bold text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Solde du compte: {{ $page.props.auth.user.balance }} {{ $page.props.app.currency }}</h2>
            </div>

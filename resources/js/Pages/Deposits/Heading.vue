<template>
    <div>
        ...
        <div class="pt-6 mx-auto w-full">
            <div class="relative px-6 py-8 overflow-hidden border border-blue-100 rounded lg:p-16 lg:flex lg:flex-col lg:items-center lg:justify-between">
                ...
                <h3 class="relative z-20 -mt-1 text-2xl sm:text-3xl text-center font-bold text-blue-900 dark:text-blue-200">

...
<template>
    ...
    <!-- Section 1 -->
    <section class="border border-primary-200 rounded shadow-lg">
        <div class="flex flex-col items-center justify-center px-5 py-8 mx-auto max-w-7xl md:px-0">
            <div class="relative">
                <h2 class="relative text-xl font-black text-transparent bg-center bg-cover bg-gradient-to-br from-indigo-400 via-indigo-600 to-indigo-500 lg:text-2xl bg-clip-text" style="background-image:url('https://cdn.devdojo.com/images/february2021/bg-colorful.jpg')">Lien d'invitation</h2>
            </div>
            <p class="mt-3 text-sm text-gray-500 lg:text-xl">Code: {{ $page.props.auth.user.referral_code }}</p>
            ...
            <span id="default-message" class="inline-flex items-center">
                ...
                <span class="text-xs font-semibold text-blue-700 dark:text-blue-500">Copié</span>
            </span>
                        </button>
                    </div>
                </div>
